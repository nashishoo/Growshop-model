// Complete list of Chilean regions and comunas (all 346 comunas)
export const REGIONES_COMUNAS = {
    ...
    'Región Metropolitana': [
        ...
        'Maipú', 'María Pinto', 'Melipilla', 'Ñuñoa', 'Padre Hurtado',
...
// Flatten all comunas for search
export const ALL_COMUNAS = Object.values(REGIONES_COMUNAS).flat().sort();

// Get region for a given comuna
export const getRegionForComuna = (comuna) => {
